...
/**
 * Longest common sequence: Doesn't have to be consecutive, but must remain
 * order
 * 
 * Let's define a two-dimension array, i is string A with length i, and j is the
 * string B with length j, c[i,j] means the LCS length of both String A and B
 * 
 * So:
 * 
...
public class LongestCommonSequence {
	...
	private int[] DisplayLCS(int[][] b, int[] x, int[] y) {
		int[] lcs = new int[b[b.length - 1][b[0].length - 1]];
		int k = lcs.length - 1;
